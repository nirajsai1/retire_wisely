...
export const  College_planning = () =>
{
  ...
  <div className="bg-green-400 py-10 px-4 sm:px-6">
    <h1 className="text-3xl font-bold text-blue-900 text-center md:text-left md:px-48">College Planning</h1>
  </div>
